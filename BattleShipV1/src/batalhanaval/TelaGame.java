...
public class TelaGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(105, 105, 105)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jbRetornar, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jbRetornar, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void squareA1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA1MouseClicked
        ...
        if(squareA1.getBackground().getRed() == 214 &&
           squareA1.getBackground().getGreen() == 217 &&
           squareA1.getBackground().getBlue() == 223)
           squareA1.setText("X");
        else {
    ...
    private void squareA2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA2MouseClicked
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA2.getBackground().getRed() == 214 &&
           squareA2.getBackground().getGreen() == 217 &&
           squareA2.getBackground().getBlue() == 223)
            squareA2.setText("X");
        else {
    ...
    private void squareA3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA3MouseClicked
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA3.getBackground().getRed() == 214 &&
           squareA3.getBackground().getGreen() == 217 &&
           squareA3.getBackground().getBlue() == 223)
           squareA3.setText("X");
        else{
    ...
    private void squareA4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA4MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA4.getBackground().getRed() == 214 &&
           squareA4.getBackground().getGreen() == 217 &&
           squareA4.getBackground().getBlue() == 223)
           squareA4.setText("X");
        else {
    ...
    private void squareA5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA5MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA5.getBackground().getRed() == 214 &&
           squareA5.getBackground().getGreen() == 217 &&
           squareA5.getBackground().getBlue() == 223)
           squareA5.setText("X");
        else {
    ...
    private void squareA6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA6MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA6.getBackground().getRed() == 214 &&
           squareA6.getBackground().getGreen() == 217 &&
           squareA6.getBackground().getBlue() == 223)
           squareA6.setText("X");
        else {
    ...
    private void squareA7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA7MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA7.getBackground().getRed() == 214 &&
           squareA7.getBackground().getGreen() == 217 &&
           squareA7.getBackground().getBlue() == 223)
           squareA7.setText("X");
        else {
    ...
    private void squareA8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareA8MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareA8.getBackground().getRed() == 214 &&
           squareA8.getBackground().getGreen() == 217 &&
           squareA8.getBackground().getBlue() == 223)
           squareA8.setText("X");
        else {
    ...
    private void squareB1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB1MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB1.getBackground().getRed() == 214 &&
           squareB1.getBackground().getGreen() == 217 &&
           squareB1.getBackground().getBlue() == 223)
           squareB1.setText("X");
        else {
    ...
    private void squareB3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB3MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB3.getBackground().getRed() == 214 &&
           squareB3.getBackground().getGreen() == 217 &&
           squareB3.getBackground().getBlue() == 223)
           squareB3.setText("X");
        else {
    ...
    private void squareB4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB4MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB4.getBackground().getRed() == 214 &&
           squareB4.getBackground().getGreen() == 217 &&
           squareB4.getBackground().getBlue() == 223)
           squareB4.setText("X");
        else {
    ...
    private void squareB5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB5MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB5.getBackground().getRed() == 214 &&
           squareB5.getBackground().getGreen() == 217 &&
           squareB5.getBackground().getBlue() == 223)
           squareB5.setText("X");
        else {
    ...
    private void squareB6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB6MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB6.getBackground().getRed() == 214 &&
           squareB6.getBackground().getGreen() == 217 &&
           squareB6.getBackground().getBlue() == 223)
           squareB6.setText("X");
        else {
    ...
    private void squareB7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB7MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB7.getBackground().getRed() == 214 &&
           squareB7.getBackground().getGreen() == 217 &&
           squareB7.getBackground().getBlue() == 223)
           squareB7.setText("X");
        else {
    ...
    private void squareB8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB8MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB8.getBackground().getRed() == 214 &&
           squareB8.getBackground().getGreen() == 217 &&
           squareB8.getBackground().getBlue() == 223)
           squareB8.setText("X");
        else {
    ...
    private void squareB2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareB2MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareB2.getBackground().getRed() == 214 &&
           squareB2.getBackground().getGreen() == 217 &&
           squareB2.getBackground().getBlue() == 223)
           squareB2.setText("X");
        else {
    ...
    private void squareC1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC1MouseClicked
        ...
        // mudar a cor do quadrado quando clicado, se cor for a padrão, inserir um x,
        // caso contrário, mostrar a cor do navio no quadrado
        if(squareC1.getBackground().getRed() == 214 &&
           squareC1.getBackground().getGreen() == 217 &&
           squareC1.getBackground().getBlue() == 223)
           squareC1.setText("X");
        else {
    ...
    private void squareC2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC2MouseClicked
        // TODO add your handling code here:
        if(squareC2.getBackground().getRed() == 214 &&
           squareC2.getBackground().getGreen() == 217 &&
           squareC2.getBackground().getBlue() == 223)
           squareC2.setText("X");
        else {
    ...
    private void squareC3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC3MouseClicked
        // TODO add your handling code here:
        if(squareC3.getBackground().getRed() == 214 &&
           squareC3.getBackground().getGreen() == 217 &&
           squareC3.getBackground().getBlue() == 223)
           squareC3.setText("X");
        else {
    ...
    private void squareC4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC4MouseClicked
        // TODO add your handling code here:
        if(squareC4.getBackground().getRed() == 214 &&
           squareC4.getBackground().getGreen() == 217 &&
           squareC4.getBackground().getBlue() == 223)
           squareC4.setText("X");
        else {
    ...
    private void squareC5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC5MouseClicked
        // TODO add your handling code here:
        if(squareC5.getBackground().getRed() == 214 &&
           squareC5.getBackground().getGreen() == 217 &&
           squareC5.getBackground().getBlue() == 223)
           squareC5.setText("X");
        else {
    ...
    private void squareC6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC6MouseClicked
        // TODO add your handling code here:
        if(squareC6.getBackground().getRed() == 214 &&
           squareC6.getBackground().getGreen() == 217 &&
           squareC6.getBackground().getBlue() == 223)
           squareC6.setText("X");
        else {
    ...
    private void squareC7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC7MouseClicked
        // TODO add your handling code here:
        if(squareC7.getBackground().getRed() == 214 &&
           squareC7.getBackground().getGreen() == 217 &&
           squareC7.getBackground().getBlue() == 223)
           squareC7.setText("X");
        else {
    ...
    private void squareC8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareC8MouseClicked
        // TODO add your handling code here:
        if(squareC8.getBackground().getRed() == 214 &&
           squareC8.getBackground().getGreen() == 217 &&
           squareC8.getBackground().getBlue() == 223)
           squareC8.setText("X");
        else {
    ...
    private void squareD1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD1MouseClicked
        // TODO add your handling code here:
        if(squareD1.getBackground().getRed() == 214 &&
           squareD1.getBackground().getGreen() == 217 &&
           squareD1.getBackground().getBlue() == 223)
           squareD1.setText("X");
        else {
    ...
    private void squareD2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD2MouseClicked
        // TODO add your handling code here:
        if(squareD2.getBackground().getRed() == 214 &&
           squareD2.getBackground().getGreen() == 217 &&
           squareD2.getBackground().getBlue() == 223)
           squareD2.setText("X");
        else {
    ...
    private void squareD3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD3MouseClicked
        // TODO add your handling code here:
        if(squareD3.getBackground().getRed() == 214 &&
           squareD3.getBackground().getGreen() == 217 &&
           squareD3.getBackground().getBlue() == 223)
           squareD3.setText("X");
        else {
    ...
    private void squareD4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD4MouseClicked
        // TODO add your handling code here:
        if(squareD4.getBackground().getRed() == 214 &&
           squareD4.getBackground().getGreen() == 217 &&
           squareD4.getBackground().getBlue() == 223)
           squareD4.setText("X");
        else {
    ...
    private void squareD5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD5MouseClicked
        // TODO add your handling code here:
        if(squareD5.getBackground().getRed() == 214 &&
           squareD5.getBackground().getGreen() == 217 &&
           squareD5.getBackground().getBlue() == 223)
           squareD5.setText("X");
        else {
    ...
    private void squareD6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD6MouseClicked
        // TODO add your handling code here:
        if(squareD6.getBackground().getRed() == 214 &&
           squareD6.getBackground().getGreen() == 217 &&
           squareD6.getBackground().getBlue() == 223)
           squareD6.setText("X");
        else {
    ...
    private void squareD7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD7MouseClicked
        // TODO add your handling code here:
        if(squareD7.getBackground().getRed() == 214 &&
           squareD7.getBackground().getGreen() == 217 &&
           squareD7.getBackground().getBlue() == 223)
           squareD7.setText("X");
        else {
    ...
    private void squareD8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareD8MouseClicked
        // TODO add your handling code here:
        if(squareD8.getBackground().getRed() == 214 &&
           squareD8.getBackground().getGreen() == 217 &&
           squareD8.getBackground().getBlue() == 223)
           squareD8.setText("X");
        else {
    ...
    private void squareE1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE1MouseClicked
        // TODO add your handling code here:
        if(squareE1.getBackground().getRed() == 214 &&
           squareE1.getBackground().getGreen() == 217 &&
           squareE1.getBackground().getBlue() == 223)
           squareE1.setText("X");
        else {
    ...
    private void squareE2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE2MouseClicked
        // TODO add your handling code here:
        if(squareE2.getBackground().getRed() == 214 &&
           squareE2.getBackground().getGreen() == 217 &&
           squareE2.getBackground().getBlue() == 223)
           squareE2.setText("X");
        else {
    ...
    private void squareE3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE3MouseClicked
        // TODO add your handling code here:
        if(squareE3.getBackground().getRed() == 214 &&
           squareE3.getBackground().getGreen() == 217 &&
           squareE3.getBackground().getBlue() == 223)
           squareE3.setText("X");
        else {
    ...
    private void squareE4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE4MouseClicked
        // TODO add your handling code here:
        if(squareE4.getBackground().getRed() == 214 &&
           squareE4.getBackground().getGreen() == 217 &&
           squareE4.getBackground().getBlue() == 223)
           squareE4.setText("X");
        else {
    ...
    private void squareE5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE5MouseClicked
        // TODO add your handling code here:
        if(squareE5.getBackground().getRed() == 214 &&
           squareE5.getBackground().getGreen() == 217 &&
           squareE5.getBackground().getBlue() == 223)
           squareE5.setText("X");
        else {
    ...
    private void squareE6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE6MouseClicked
        // TODO add your handling code here:
        if(squareE6.getBackground().getRed() == 214 &&
           squareE6.getBackground().getGreen() == 217 &&
           squareE6.getBackground().getBlue() == 223)
           squareE6.setText("X");
        else {
    ...
    private void squareE7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE7MouseClicked
        // TODO add your handling code here:
        if(squareE7.getBackground().getRed() == 214 &&
           squareE7.getBackground().getGreen() == 217 &&
           squareE7.getBackground().getBlue() == 223)
           squareE7.setText("X");
        else {
    ...
    private void squareE8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareE8MouseClicked
        // TODO add your handling code here:
        if(squareE8.getBackground().getRed() == 214 &&
           squareE8.getBackground().getGreen() == 217 &&
           squareE8.getBackground().getBlue() == 223)
           squareE8.setText("X");
        else {
    ...
    private void squareF2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF2MouseClicked
        // TODO add your handling code here:
        if(squareF2.getBackground().getRed() == 214 &&
           squareF2.getBackground().getGreen() == 217 &&
           squareF2.getBackground().getBlue() == 223)
           squareF2.setText("X");
        else {
    ...
    private void squareF1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF1MouseClicked
        // TODO add your handling code here:
        if(squareF1.getBackground().getRed() == 214 &&
           squareF1.getBackground().getGreen() == 217 &&
           squareF1.getBackground().getBlue() == 223)
           squareF1.setText("X");
        else {
    ...
    private void squareF3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF3MouseClicked
        // TODO add your handling code here:
        if(squareF3.getBackground().getRed() == 214 &&
           squareF3.getBackground().getGreen() == 217 &&
           squareF3.getBackground().getBlue() == 223)
           squareF3.setText("X");
        else {
    ...
    private void squareF4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF4MouseClicked
        // TODO add your handling code here:
        if(squareF4.getBackground().getRed() == 214 &&
           squareF4.getBackground().getGreen() == 217 &&
           squareF4.getBackground().getBlue() == 223)
           squareF4.setText("X");
        else {
    ...
    private void squareF5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF5MouseClicked
        // TODO add your handling code here:
        if(squareF5.getBackground().getRed() == 214 &&
           squareF5.getBackground().getGreen() == 217 &&
           squareF5.getBackground().getBlue() == 223)
           squareF5.setText("X");
        else {
    ...
    private void squareF6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF6MouseClicked
        // TODO add your handling code here:
        if(squareF6.getBackground().getRed() == 214 &&
           squareF6.getBackground().getGreen() == 217 &&
           squareF6.getBackground().getBlue() == 223)
           squareF6.setText("X");
        else {
    ...
    private void squareF7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF7MouseClicked
        // TODO add your handling code here:
        if(squareF7.getBackground().getRed() == 214 &&
           squareF7.getBackground().getGreen() == 217 &&
           squareF7.getBackground().getBlue() == 223)
           squareF7.setText("X");
        else {
    ...
    private void squareF8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareF8MouseClicked
        // TODO add your handling code here:
        if(squareF8.getBackground().getRed() == 214 &&
           squareF8.getBackground().getGreen() == 217 &&
           squareF8.getBackground().getBlue() == 223)
           squareF8.setText("X");
        else {
    ...
    private void squareG1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG1MouseClicked
        // TODO add your handling code here:
        if(squareG1.getBackground().getRed() == 214 &&
           squareG1.getBackground().getGreen() == 217 &&
           squareG1.getBackground().getBlue() == 223)
           squareG1.setText("X");
        else {
    ...
    private void squareG2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG2MouseClicked
        // TODO add your handling code here:
        if(squareG2.getBackground().getRed() == 214 &&
           squareG2.getBackground().getGreen() == 217 &&
           squareG2.getBackground().getBlue() == 223)
           squareG2.setText("X");
        else {
    ...
    private void squareG3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG3MouseClicked
        // TODO add your handling code here:
        if(squareG3.getBackground().getRed() == 214 &&
           squareG3.getBackground().getGreen() == 217 &&
           squareG3.getBackground().getBlue() == 223)
           squareG3.setText("X");
        else {
    ...
    private void squareG4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG4MouseClicked
        // TODO add your handling code here:
        if(squareG4.getBackground().getRed() == 214 &&
           squareG4.getBackground().getGreen() == 217 &&
           squareG4.getBackground().getBlue() == 223)
           squareG4.setText("X");
        else {
    ...
    private void squareG5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG5MouseClicked
        // TODO add your handling code here:
        if(squareG5.getBackground().getRed() == 214 &&
           squareG5.getBackground().getGreen() == 217 &&
           squareG5.getBackground().getBlue() == 223)
           squareG5.setText("X");
        else {
    ...
    private void squareG6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG6MouseClicked
        // TODO add your handling code here:
        if(squareG6.getBackground().getRed() == 214 &&
           squareG6.getBackground().getGreen() == 217 &&
           squareG6.getBackground().getBlue() == 223)
           squareG6.setText("X");
        else {
    ...
    private void squareG7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG7MouseClicked
        // TODO add your handling code here:
        if(squareG7.getBackground().getRed() == 214 &&
           squareG7.getBackground().getGreen() == 217 &&
           squareG7.getBackground().getBlue() == 223)
           squareG7.setText("X");
        else {
    ...
    private void squareG8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareG8MouseClicked
        // TODO add your handling code here:
        if(squareG8.getBackground().getRed() == 214 &&
           squareG8.getBackground().getGreen() == 217 &&
           squareG8.getBackground().getBlue() == 223)
           squareG8.setText("X");
        else {
    ...
    private void squareH1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH1MouseClicked
        // TODO add your handling code here:
        if(squareH1.getBackground().getRed() == 214 &&
           squareH1.getBackground().getGreen() == 217 &&
           squareH1.getBackground().getBlue() == 223)
           squareH1.setText("X");
        else {
    ...
    private void squareH2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH2MouseClicked
        // TODO add your handling code here:
        if(squareH2.getBackground().getRed() == 214 &&
           squareH2.getBackground().getGreen() == 217 &&
           squareH2.getBackground().getBlue() == 223)
           squareH2.setText("X");
        else {
    ...
    private void squareH3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH3MouseClicked
        // TODO add your handling code here:
        if(squareH3.getBackground().getRed() == 214 &&
           squareH3.getBackground().getGreen() == 217 &&
           squareH3.getBackground().getBlue() == 223)
           squareH3.setText("X");
        else {
    ...
    private void squareH4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH4MouseClicked
        // TODO add your handling code here:
        if(squareH4.getBackground().getRed() == 214 &&
           squareH4.getBackground().getGreen() == 217 &&
           squareH4.getBackground().getBlue() == 223)
           squareH4.setText("X");
        else {
    ...
    private void squareH5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH5MouseClicked
        // TODO add your handling code here:
        if(squareH5.getBackground().getRed() == 214 &&
           squareH5.getBackground().getGreen() == 217 &&
           squareH5.getBackground().getBlue() == 223)
           squareH5.setText("X");
        else {
    ...
    private void squareH6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH6MouseClicked
        // TODO add your handling code here:
        if(squareH6.getBackground().getRed() == 214 &&
           squareH6.getBackground().getGreen() == 217 &&
           squareH6.getBackground().getBlue() == 223)
           squareH6.setText("X");
        else {
    ...
    private void squareH7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH7MouseClicked
        // TODO add your handling code here:
        if(squareH7.getBackground().getRed() == 214 &&
           squareH7.getBackground().getGreen() == 217 &&
           squareH7.getBackground().getBlue() == 223)
           squareH7.setText("X");
        else {
    ...
    private void squareH8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_squareH8MouseClicked
        // TODO add your handling code here:
        if(squareH8.getBackground().getRed() == 214 &&
           squareH8.getBackground().getGreen() == 217 &&
           squareH8.getBackground().getBlue() == 223)
           squareH8.setText("X");
        else {
    ...
    private void jbRetornarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRetornarMouseEntered
        // TODO add your handling code here:
        jbRetornar.setBackground(new Color(16, 106, 169));
        jbRetornar.setForeground(Color.WHITE);
    ...
    private void jbRetornarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbRetornarMouseExited
        ...
        jbRetornar.setForeground(Color.BLACK);
